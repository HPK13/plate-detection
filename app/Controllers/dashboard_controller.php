    ...
    public function scanNumberPlate()
{
    ...
    $visitor = $visitorModel->where('license_plate', $plateNumber)->first();
    ...
    public function vehiclesInside()
{
    ...
    public function searchVehicles()
    {
        ...
        $licensePlate = $request->getGet('license_plate');
...
public function registerVisitorSubmit()
{
    ...
    $data = [
        ...
        'license_plate' => strtoupper($request->getPost('license_plate')), // Convert to uppercase
